# NgVirtualList News Feed Demo

✨ NgVirtualList News Feed Demo (ng-virtual-list-news-feed) is an Angular-based showcase application designed to demonstrate high-performance rendering of long message history using virtual scrolling techniques.
...
[Live Demo](https://news-feed.eugene-grebennikov.pro/)
...
```bash
git clone https://github.com/DjonnyX/ng-virtual-list-news-feed.git
cd ng-virtual-list-news-feed
```
